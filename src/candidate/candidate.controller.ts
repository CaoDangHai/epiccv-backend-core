import { Controller, Get, Put, Body, UseGuards, Req, Post, UseInterceptors, UploadedFile, BadRequestException } from '@nestjs/common';
...
export class CandidateController {
    ...
    @Put('password')
    async changePassword(@Req() req: RequestWithUser, @Body() data: ChangePasswordDto) {
